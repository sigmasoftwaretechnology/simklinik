...
$(function () {
	$("#filter").click(function(){
        ajaxLoad(__base_url__+"rekam-medis/pendaftaran?awal="+$("#filterTanggal1").val()+"&akhir="+$("#filterTanggal2").val()+"&nama="+$("#filterNama").val());
    }); 
...
$('#modal-form-update').on('show.bs.modal', function (event) {
	var button = $(event.relatedTarget);
	ajaxLoad(button.data('href'), 'modal-content-form-update');
});
