...
$(function () {
	$("#filter").click(function(){
        ajaxLoad(__base_url__+"rekam-medis/pasien?by="+$("#filterBy").val()+"&isi="+$("#filterNama").val());
    }); 
});
$('#modal-form-pasien').on('show.bs.modal', function (event) {
	var button = $(event.relatedTarget);
	ajaxLoad(button.data('href'), 'modal-content-form-pasien');
});
	...
	$.ajax({
		...
		success: function (data) {
			...
			if (data.fail) {
				...
				$('#modal-form-pasien').modal('hide');
				ajaxLoad(__base_url__+"pasien?by="+$("#filterBy").val()+"&isi="+$("#filterNama").val());
			}
		},
