<div class="modal-header">
	...
	<div class="card-body">
		<div class="row mb-2">
			<div class="col-12">
			<form method="POST" id="frmDetailObat" action="<?php echo base_url();?>/farmasi/obat/detail" class="form-horizontal">
					<div class="row">
						<div class="col-2">
							<div class="form-group">
								<label>Satuan</label>
								<input type="text" class="form-control form-control-sm" name="satuan" value="">
						...
						<div class="col-4">
							<div class="form-group">
								...
								<input type="text" class="form-control form-control-sm" name="batch" value="">
						...
						<div class="col-2">
							<div class="form-group">
								<label >Expired</label>
								<input type="text" class="form-control form-control-sm" name="kadaluarsa" value="">
						...
						<div class="col-2">
							<div class="form-group">
								<label >Harga</label>
								<input type="text" class="form-control form-control-sm" name="harga" value="">
						...
						<div class="col-2">
							<div class="form-group">
								<label >Stok</label>
								<input type="text" class="form-control form-control-sm" name="stok" value="">
					  ...
					  <?php foreach($row as $data):?>
						<tr>
						  ...
						  <td class="text-center">
							<button type="button" id="update-detail-<?=$data["id"]?>"   data-id="<?=$data["id"]?>" data-id_obat="<?=$data["id_obat"]?>" data-batch="<?=$data["batch"]?>" data-kadaluarsa="<?=date("d-m-Y",strtotime($data["kadaluarsa"]))?>" data-stok="<?=$data["stok"]?>" data-satuan="<?=$data["satuan"]?>" data-harga="<?=$data["harga"]?>" data-href="<?=base_url()?>/obat/ubah-detail?id=<?=$data["id"]?>" class="edit-detail btn btn-outline-info btn-flat btn-xs"><i class="fa fa-edit"></i> Edit</button>
