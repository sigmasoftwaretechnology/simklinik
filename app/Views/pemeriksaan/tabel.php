            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center">
								<?php
                                $no_antrian = explode("-", $data->antrian);
                                ?>

                        <a href="<?php echo base_url();?>/rekam-medis/pemeriksaan?q=<?=$data->id?>" id="periksa-px"><img
                                src="<?php echo base_url(); ?>/assets/img/icon/doctor.png"></a>
                        <a id="panggil" data-no_reg="<?=$data->no_reg?>" 
							data-huruf="<?=isset($no_antrian['0'])?strtolower($no_antrian['0']):""?>"
							data-nomor="<?=isset($no_antrian['1'])?$no_antrian['1']:$no_antrian['0']?>"
                            data-suara="<?php echo str_replace(' ', '', strtolower($data->poli));?>"
                            data-poli="<?=$data->poli?>"><img
                                src="<?php echo base_url(); ?>/assets/img/icon/mic.png"></button>
                    </td>
