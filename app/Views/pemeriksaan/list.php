...
<section class="content">
    <div class="container-fluid">
        <div class="row">			
			...
			<?php echo view('pemeriksaan/tabel'); ?>
			</div>
					...
					<div class="modal-content">
						...
						<div class="modal-footer">
							...
							<button type="button" class="btn btn-danger"
								onclick="ajaxDelete('<?=base_url()?>/pendaftaran/hapus?id='+$('#delete_id').val())">
								Delete
							</button>
						</div>
					</div>
...
<script src="<?php echo base_url("assets/js/page/pasien-registrasi.js");?>"></script>
<?= $this->endSection() ?>