<div class="modal-header">
    <?php echo isset($data["_id"]) ? "Ubah Supplier" : "Tambah Supplier"?>
    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
        <span aria-hidden="true">&times;</span>
    </button>
</div>
<?php if(isset($data["_id"])):?>
<form method="POST" id="frmTindakan" action="<?php echo base_url();?>/farmasi/supplier/ubah?id=<?=$data["_id"]?>" class="form-horizontal">
<?php else:?>
