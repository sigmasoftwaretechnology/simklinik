			...
			<div class="col-12">
				<div class="card card-outline card-success">
					...
					<div class="card-body">
						...
						<form class="form-horizontal" id="frm-resep" action="<?php echo base_url();?>/farmasi/resep/save-resep-bebas" method="POST"> 
							<div class="row">
								<div class="col-12">
									<table class="table table-sm table-hover table-bordered table-head-fixed text-nowrap mb-0">
									  ...
									  <tbody id="body-resep">
										...
										<?php $i=1;foreach($dataRegis->resep_obat as $obat):?>
									  	<tr>
										<td>
											<input type="hidden" name="id_obat[<?=$i?>]" value="2">
										...
										<td><?=$obat->jumlah?></td>
										<td style="text-align:right"><?="Rp " . number_format($obat->harga,2,',','.')?></td>
										<td style="text-align:right"><?="Rp " . number_format($obat->harga*$obat->jumlah,2,',','.')?></td>
										<td class="d-none">
							...
							<div class="row" id="btn-grup">
								<div class="col-6">
								<button type="button" id="simpan-resep" class="btn btn-block btn-outline-primary btn-xs">Simpan Resep</button>
								</div>
							</div>
						</form>		
					</div>
