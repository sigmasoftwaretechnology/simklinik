...
<section class="content">
    <div class="container-fluid">
        <div class="row">
			...
			<?php echo view('resep-bebas/tabel'); ?>
			</div>
...
<script src="<?php echo base_url("assets/js/page/resep-bebas.js");?>"></script>
<?= $this->endSection() ?>