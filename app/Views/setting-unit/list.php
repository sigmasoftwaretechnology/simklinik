...
<section class="content">
    <div class="container-fluid">
        <div class="row">
					...
					<div class="card-body p-2">
						<div class="row">
							<div class="col-4">
								...
								data-backdrop="static" data-toggle="modal" data-href="<?php echo base_url();?>/setting/unit/tambah" href="#modal-form-baru"><img src="<?php echo base_url(); ?>/assets/img/icon/plus.png"> Tambah Unit Kerja</button>
							</div>
						</div>
					</div>
				</div>
			...
			<?php echo view('setting-unit/tabel'); ?>
			</div>
					...
					<div class="modal-content">
						...
						<div class="modal-footer">
							...
							<button type="button" class="btn btn-danger"
								onclick="ajaxDelete('<?=base_url()?>/setting/unit/hapus?id='+$('#delete_id').val())">
								Hapus
							</button>
						</div>
					</div>
...
<script src="<?php echo base_url("assets/js/page/setting-unit.js");?>"></script>
<?= $this->endSection() ?>