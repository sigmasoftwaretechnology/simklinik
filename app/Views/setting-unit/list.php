					...
					<div class="card-body p-2">
						<div class="row">
							<div class="col-4">
								...
								data-backdrop="static" data-toggle="modal" data-href="<?php echo base_url();?>/setting/unit/tambah" href="#modal-form-baru"><i class="far fa-plus-square"></i> Tambah Unit Kerja</button>
							</div>
						</div>
					</div>
				</div>
