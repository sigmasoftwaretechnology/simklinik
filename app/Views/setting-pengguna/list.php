...
<section class="content">
    <div class="container-fluid">
        <div class="row">
			...
			<?php echo view('setting-pengguna/tabel'); ?>
			</div>
					...
					<div class="modal-content">
						...
						<div class="modal-footer">
							...
							<button type="button" class="btn btn-danger"
								onclick="ajaxDelete('<?=base_url()?>/setting/pengguna/hapus?id='+$('#delete_id').val())">
								Hapus
							</button>
						</div>
					</div>
...
<script src="<?php echo base_url("assets/js/page/setting-pengguna.js");?>"></script>
<?= $this->endSection() ?>